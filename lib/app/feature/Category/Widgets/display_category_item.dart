...
class DisplayCategoryItem extends StatelessWidget {
  ...
  const DisplayCategoryItem({Key? key, required this.taskCategory, required this.deleteCategory, }) : super(key: key);
                ...
                IconButton(
                  onPressed: () {
                    ...
                    builder: (BuildContext context) {
                      return  AddCategoryWidget(categoryToUpdate: taskCategory,);
                    },
                    );                  },
